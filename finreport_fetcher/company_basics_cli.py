...
from .global_datasets import clear_dataset_raw_files, fetch_company_basics_dataset, resolve_existing_dataset_paths
...
@app.callback()
def _root():
    """兼容入口：建议改用 python3 -m fincompany_fetcher fetch。"""
